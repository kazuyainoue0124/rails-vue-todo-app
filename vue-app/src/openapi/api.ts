...
export const TodoApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async apiV1GetTodos(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<ApiV1GetTodos200Response>
    > {
...
export const TodoApiFactory = function (
  ...
  return {
    ...
    apiV1PutTodoById(id: number, todo: Todo, options?: any): AxiosPromise<Todo> {
      return localVarFp
        .apiV1PutTodoById(id, todo, options)
        .then((request) => request(axios, basePath));
    }
  };
};
